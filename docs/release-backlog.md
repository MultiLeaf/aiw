...
- [ ] **REL-002** Approve the public package license and configure secure npm publishing for `MultiLeaf/aiw`. _Progress:_ MIT is approved and the protected GitHub `npm` environment is configured; the first-release granular npm token is pending.
